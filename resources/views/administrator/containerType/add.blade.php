...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-10 administrator-container">
        ...
        <div class="box box-info">
          ...
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('administrator/containerType') }}">
            {!! csrf_field() !!}
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" placeholder="Container Type" 
      ...
      <div class="col-xs-10 container-view">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View</h3>
            <div class="box-tools">
              <form method='GET' action="{{ newurl('administrator/containerType') }}">
              ...
              <?php foreach ($data as $value): ?>
                <tr>
                  ...
                  <td> <div class="btn-group">
                    <a class="btn btn-success admin-edit" href="?edit=<?php echo $value->container_type_id; ?>">Edit</a>
                    
                    <?php echo '<a class="btn btn-success admin-edit" 
                      href="'.URL::to('/').'/administrator/delete/'.$value->container_type_id.'/container_type/container_type_id">Delete</a>';?>
                    </div>
                  </td>
                </tr>
              <?php endforeach;?>
