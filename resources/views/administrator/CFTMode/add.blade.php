...
@section('content')
  <section class="content-header">
    <h1> Ocean Freight Transportation Mode Selection </h1>
    <!--<ol class="breadcrumb">
      <li><a href="{{ newurl('/administrator/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">OFT Mode Selection List</li>
    </ol>-->
  </section>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-10 administrator-cft">
        ...
        <div class="box box-info">
          ...
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('administrator/CFTMode') }}">
            {!! csrf_field() !!}
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" placeholder="OFT Mode Name" 
      ...
      <div class="col-xs-10 cft-view">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View</h3>
            <div class="box-tools">
              <form method='GET' action="{{ newurl('administrator/CFTMode') }}">
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?php foreach ($data as $value): ?>
                <tr>
                  <td> <?php echo $value->cft_mode_id; ?> </td>
                  <td> <?php echo $value->title; ?> </td>
                  <td> <?php echo date('d-m-Y', strtotime($value->created)); ?> </td>
                  

                  <td> <div class="btn-group">
                    <a class="btn btn-success" href="?edit=<?php echo $value->cft_mode_id; ?>">Edit</a>
                    
                    <?php echo '<a class="btn btn-success" 
                      href="'.URL::to('/').'/administrator/delete/'.$value->cft_mode_id.'/cft_mode/cft_mode_id">Delete</a>';?>
                    </div>
                  </td>
                </tr>
              <?php endforeach;?>
