...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-10 administrator-cities">
        ...
        <div class="box box-info">
          ...
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('administrator/cities') }}">
            {!! csrf_field() !!}
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" placeholder="City Name" 
      ...
      <div class="col-xs-10 cities-view">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View</h3>
            <div class="box-tools">
              <form method='GET' action="{{ newurl('administrator/cities') }}">
              ...
              <?php foreach ($data as $value): ?>
                <tr>
                  ...
                  <td> <div class="btn-group">
                    <a class="btn btn-success admin-edit" href="?edit=<?php echo $value->city_id; ?>">Edit</a>
                    
                    <?php echo '<a class="btn btn-success admin-edit" href="'.URL::to('/').'/administrator/delete/'.$value->city_id.'/cities/city_id">Delete</a>';
                      if($value->is_active == 1){
                          ...
                          //       <form class="form pull-left" id="decline-form" style="width: 200px;" dec-table="cities" dec-field="city_id" 
                          //         dec-id="'.$value->city_id.'" dec-status="2">
                          ...
                          echo '<a class="btn btn-success admin-edit" href="'.URL::to('/').'/administrator/status/'.$value->city_id.'/1/cities/city_id/null">Active</a>';} 
                      ?>
                    </div>
                  </td>
                </tr>
