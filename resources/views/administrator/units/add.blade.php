...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-10 administrator-units">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <?php  $data = $units['result']; $edit = $units['edit']; ?>
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('administrator/units') }}">
            {!! csrf_field() !!}
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" placeholder="Unit Name" 
      ...
      <div class="col-xs-10 units-view">
        <div class="box">
              ...
              <?php foreach ($data as $value): ?>
                <tr>
                  ...
                  <td> <div class="btn-group">
                    <a class="btn btn-success admin-edit" href="?edit=<?php echo $value->unit_id; ?>">Edit</a>
                    
                    <?php echo '<a class="btn btn-success admin-edit" href="'.URL::to('/').'/administrator/delete/'.$value->unit_id.'/units/unit_id">Delete</a>';
                    if($value->is_active == 1){
                          ...
                          //       <form class="form pull-left" id="decline-form" style="width: 200px;" dec-table="units" dec-field="unit_id" 
                          //         dec-id="'.$value->unit_id.'" dec-status="2">
                          ...
                          echo '<a class="btn btn-success admin-edit" href="'.URL::to('/').'/administrator/status/'.$value->unit_id.'/1/units/unit_id/null">Active</a>';} 
                      ?>
                    </div>
                  </td>
                </tr>
