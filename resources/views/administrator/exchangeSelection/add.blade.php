...
@section('content')
  <section class="content-header">
    ...
    <!--<ol class="breadcrumb">
      ...
      <li class="active">Exchange Selection List</li>
    </ol>-->
  </section>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-10 administrator-exchange">
        ...
        <div class="box box-info">
          ...
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('administrator/exchangeSelection') }}">
            {!! csrf_field() !!}
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" placeholder="Exchange Selection Name" 
      ...
      <div class="col-xs-10 exchange-view">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View</h3>
            <div class="box-tools">
              <form method='GET' action="{{ newurl('administrator/exchangeSelection') }}">
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?php foreach ($data as $value): ?>
                <tr>
                  <td> <?php echo $value->exchange_selection_id; ?> </td>
                  <td> <?php echo $value->title; ?> </td>
                  <td> <?php echo date('d-m-Y', strtotime($value->created)); ?> </td>
                  <td> <div class="btn-group">
                    <a class="btn btn-success admin-edit" href="?edit=<?php echo $value->exchange_selection_id; ?>">Edit</a>
                    <?php echo '<a class="btn btn-success admin-edit" 
                      href="'.URL::to('/').'/administrator/delete/'.$value->exchange_selection_id.'/exchange_selection/exchange_selection_id">
                      Delete</a>';?>
                    </div>
                  </td>
                </tr>
