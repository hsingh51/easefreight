...
@section('content')
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-10 administrator-services">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <?php  $data = $services['result']; $edit = $services['edit']; ?>
          <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('administrator/services') }}">
            {!! csrf_field() !!}
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" placeholder="Service Name" 
      ...
      <div class="col-xs-10 services-view">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">View</h3>
            <div class="box-tools">
              <form method='GET' action="{{ newurl('administrator/services') }}">
              ...
              <?php foreach ($data as $value): ?>
                <tr>
                  ...
                  <td> <div class="btn-group">
                    <a class="btn btn-success admin-edit" href="?edit=<?php echo $value->service_id; ?>">Edit</a>
                    
                    <?php echo '<a class="btn btn-success admin-edit" href="'.URL::to('/').'/administrator/delete/'.$value->service_id.'/services/service_id">Delete</a>';
                    if($value->is_active == 1){
                          ...
                          //       <form class="form pull-left" id="decline-form" style="width: 200px;" dec-table="services" dec-field="service_id" 
                          //         dec-id="'.$value->service_id.'" dec-status="2">
                          ...
                          echo '<a class="btn btn-success admin-edit" href="'.URL::to('/').'/administrator/status/'.$value->service_id.'/1/services/service_id/null">Active</a>';} 
                      ?>
                    </div>
                  </td>
                </tr>
