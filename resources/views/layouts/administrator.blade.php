...
<html>
  <head>
    ...
    <title>::EASEFREIGHT:: Freight Administrator</title>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/administrator_custom.css') }}">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
	<link rel="stylesheet" href="http://easefreight.com/ease-freight/public/assets/css/administrator.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="{{ newurl('/administrator/dashboard') }}" class="logo top-logo">
          <img src="{{ URL::asset('assets/img/logo1.png') }}" alt="Logo" height='70' class="pull-left">
        ...
        <nav class="navbar navbar-static-top nav-bar" role="navigation">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header administrator-head">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ newurl('/administrator/profile') }}" class="btn btn-default btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href="{{ newurl('/administrator/logout') }}" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      @include('administrator.partials.left')
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2017 <a href="{{ newurl('/') }}">Ease Freight</a>.</strong> All rights reserved.
      </footer>
    ...
    <?php include('assets/js/administrator-custom.php'); ?>
