        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ newurl('/freight/register') }}">
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
        ...
        // $('div#termsConditions').on('dialogclose', function(event) {
