        ...
        <div class="box">
          <div class="box-body table-responsive no-padding box-height datesdiv">
            <table class="table table-hover maintb <?php //echo $key;?>">
                  ...
                  <?php if(@$data->itineraryDeparture){
                    $dates = $data->itineraryDeparture;
                    $a = 1;
                          foreach ( $dates as $val) {
                  ?>
                            @include('admin.rates.itinerary.rowair',array('key'=>$key,'row_number'=>$a,'rowdata'=>$val))
                  <?php
                           $a++; 
                          }
                         
                    }else{?>
                            @include('admin.rates.itinerary.rowair',array('key'=>$key,'row_number'=>'1'))
                  <?php }?>
